...
compute_cap(fcidvr_file = 'fcidvr_2ele_singlet.npz', acap = -25.0, bcap = 25.0, ncap = 2)
fcicap_data = np.load('fcicap_2ele_singlet.npz')
print(fcicap_data['wi'])
print(fcicap_data['Wnm'].real)
