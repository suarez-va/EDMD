...
# for 2 electrons and quantum nuclei you'll need (H2ele1nuc, W2ele1nuc) (LinearOperator),
# (H1ele1nuc, W1ele1nuc) (LinearOperator), H1nuc (LinearOperator), eta (float), wi ((nxdvr) np.ndarray),
# DipnI ((nxdvr, nbo1, nbo2, nRdvr) np.ndarray), CipI ((nxdvr, nbo1, nRdvr) np.ndarray),
# GimnI ((nxdvr, nbo2, nbo2, nRdvr) np.ndarray), GipqI ((nxdvr, nbo1, nbo1, nRdvr) np.ndarray)
#
class LindbladCAP:
